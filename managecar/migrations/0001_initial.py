    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('BLUE', 'silver'), ('RED', 'Red'), ('PINK', 'Pink'), ('ORA', 'Orange'), ('BLA', 'Black'), ('WHI', 'White'), ('SIL', 'Silver'), ('BRO', 'Bronze'), ('YEL', 'Yellow')], max_length=4)),
                ...
                ('type_gear', models.CharField(choices=[('AUT', 'Manual Transmission'), ('MAN', 'Automatic Transmission'), ('CBT', 'CVT Transmission'), ('DTC', 'Semi-automatic and Dual-clutch Transmission (DCT)')], max_length=3)),
